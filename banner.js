...
(function() {
    ...
    const CONFIG = {"token":"","themeColor":"#155265","bannerTitle":"We value your privacy","bannerDescription":"We use cookies to improve your experience, analyze site traffic, and personalize content. By clicking \"Accept all,\" you agree to our use of cookies. You can manage your preferences or learn more in our Cookie Policy.","privacyUrl":"https://www.kawach.ai/privacy-policy","endpoint":"https://staging.kawach.ai/api/cookie_consent","consentExpiryDays":365,"categories":["NECESSARY","ANALYTICS","MARKETING","FUNCTIONAL"],"consentVersion":1,"css":"\n  .cookie-banner {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    background: #0f172a;\n    color: #e5e7eb;\n    padding: 20px 24px;\n    z-index: 9999;\n    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;\n  }\n\n  .cookie-banner-content {\n    max-width: 1300px;\n    margin: 0 auto;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    gap: 24px;\n  }\n\n  .cookie-banner-text h2 {\n    margin: 0 0 6px 0;\n    font-size: 16px;\n    font-weight: 600;\n    color: #ffffff;\n  }\n\n  .cookie-banner-text p {\n    margin: 0;\n    font-size: 14px;\n    color: #cbd5f5;\n    line-height: 1.5;\n  }\n\n  .cookie-banner-text a {\n    color: #155265;\n    text-decoration: none;\n    font-size: 14px;\n    margin-top: 6px\n  }\n\n  .cookie-banner-text a:hover {\n    text-decoration: underline;\n  }\n\n  .cookie-banner-actions {\n    display: flex;\n    align-items: center;\n    gap: 20px;\n    flex-shrink: 0;\n  }\n\n  .cookie-btn {\n    font-size: 14px;\n    font-weight: 500;\n    cursor: pointer;\n    border: none;\n    background: none;\n    padding: 0;\n  }\n\n  .cookie-btn-primary {\n    background: #155265;\n    color: #ffffff;\n    padding: 10px 20px;\n    border-radius: 9999px;\n    font-weight: 600;\n  }\n\n  .cookie-btn-primary:hover {\n    opacity: 0.95;\n  }\n\n  .cookie-btn-secondary {\n    color: color-mix(in srgb, #155265 75%, white);\n  }\n\n  .cookie-btn-secondary:hover {\n    text-decoration: underline;\n  }\n\n  .cookie-btn-tertiary {\n    color: #000000;\n    background-color: #c4cacf;\n    padding: 10px 20px;\n    border-radius: 9999px;\n  }\n\n  .cookie-btn-tertiary:hover {\n    opacity: 0.95;\n  }\n\n  .preference-overlay {\n    position: fixed;\n    inset: 0;\n    background: rgba(0, 0, 0, 0.55);\n    z-index: 9998;\n  }\n\n  .cookie-preference-panel {\n    position: fixed;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%) scale(0.96);\n    width: 480px;\n    max-width: calc(100vw - 40px);\n    max-height: calc(100vh - 80px);\n    background: #ffffff;\n    border-radius: 16px;\n    box-shadow: 0 25px 60px rgba(0, 0, 0, 0.25);\n    z-index: 10000;\n    overflow-y: auto;\n    padding: 32px;\n    animation: popupIn 0.25s ease-out forwards;\n  }\n\n  @keyframes popupIn {\n    from { opacity: 0; transform: translate(-50%, -50%) scale(0.94); }\n    to { opacity: 1; transform: translate(-50%, -50%) scale(1); }\n  }\n\n  .preference-header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 28px;\n  }\n\n  .preference-header h2 {\n    margin: 0;\n    font-size: 22px;\n    font-weight: 600;\n    color: #111;\n  }\n\n  .preference-close {\n    background: none;\n    border: none;\n    font-size: 28px;\n    cursor: pointer;\n    color: #999;\n  }\n\n  .category-section {\n    margin-bottom: 0;\n    padding-bottom: 24px;\n    border-bottom: 1px solid #e5e7eb;\n  }\n\n  .category-section:last-child {\n    border-bottom: none;\n    padding-bottom: 0;\n  }\n\n  .category-header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 8px;\n  }\n\n  .category-header h3 {\n    margin: 0;\n    font-size: 15px;\n    font-weight: 600;\n    color: #111;\n  }\n\n  .category-description {\n    font-size: 13px;\n    color: #666;\n    margin-bottom: 12px;\n  }\n\n  .toggle-switch {\n    width: 50px;\n    height: 28px;\n    background: #d1d5db;\n    border-radius: 9999px;\n    position: relative;\n    cursor: pointer;\n    transition: background 0.2s;\n    --toggle-color: #155265;\n    margin-top: 4px;\n  }\n\n  .toggle-switch::after {\n    content: '';\n    position: absolute;\n    width: 24px;\n    height: 24px;\n    background: #ffffff;\n    border-radius: 50%;\n    top: 2px;\n    left: 2px;\n    transition: transform 0.2s;\n  }\n\n  .toggle-switch.active {\n    background: var(--toggle-color);\n  }\n\n  .toggle-switch.active::after {\n    transform: translateX(22px);\n  }\n\n  .toggle-switch.necessary-disabled {\n    background: var(--toggle-color);\n    cursor: not-allowed;\n    opacity: 0.65;\n  }\n\n  .toggle-switch.necessary-disabled::after {\n    transform: translateX(22px);\n  }\n\n  .required-tag {\n    display: inline-block;\n    background-color: #22c55e;\n    color: #fff;\n    font-size: 11px;\n    font-weight: 600;\n    padding: 2px 6px;\n    border-radius: 4px;\n    margin-left: 8px;\n    vertical-align: middle;\n  }\n\n  .preference-footer {\n    display: flex;\n    flex-direction: column;\n    gap: 12px;\n    margin-top: 32px;\n    padding-top: 24px;\n    border-top: 1px solid #e5e7eb;\n  }\n\n  .save-btn {\n    flex: none;\n    background: #155265;\n    color: #ffffff;\n    padding: 12px;\n    border-radius: 8px;\n    font-weight: 600;\n    border: none;\n    cursor: pointer;\n  }\n\n  .save-btn:hover {\n    opacity: 0.95;\n  }\n\n  #powered-by-kawach {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n    margin-top: 12px;\n    gap: 4px;\n  }\n\n  #powered-by-kawach::before {\n    content: 'Powered by';\n    font-size: 12px;\n    color: #666;\n  }\n\n  #powered-by-kawach img {\n    height: 19px;\n  }\n\n  @media (max-width: 768px) {\n    .cookie-banner-content {\n      flex-direction: column;\n      align-items: flex-start;\n    }\n\n    .cookie-banner-actions {\n      width: 100%;\n      justify-content: space-between;\n    }\n\n    .cookie-preference-panel {\n      width: calc(100vw - 24px);\n      max-height: calc(100vh - 24px);\n      padding: 24px;\n      border-radius: 12px;\n    }\n  }\n"};
    (CONFIG => {
